...
## Genomes for MLST and cgMLST analysis



## MLST prediction using mlst-check



## cgMLST prediction using chewBBACA



## MLST and cgMLST comparative visualisation (Phyloviz and GrapeTree)
